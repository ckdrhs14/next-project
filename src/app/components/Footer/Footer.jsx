        ...
        <footer className={styles.footer}>
            <div className={styles.inner}>
                <div className={styles.cont}>
                    <div className={styles.logo}><Image src="/assets/icons/logo_w.svg" alt="밝은성모안과의원" fill /></div>
                    <div className={styles.info_wrap}>
                        <div className={styles.info_top}>
                            <div className={styles.info_link}>
                                <Link href="https://www.oklasik.com/?p=100">개인정보처리방침</Link>
                                <Link href="https://www.oklasik.com/?p=101">이용안내</Link>
                                <Link href="https://www.oklasik.com/?p=43">제휴/광고제안</Link>
                                <Link href="https://www.oklasik.com/?p=102">환자권리장전</Link>
                                <Link href="https://www.oklasik.com/?p=315">비급여재료비</Link>
                            </div>
                            <div className={styles.sns_wrap}>
                                <Link href="https://www.youtube.com/channel/UCjhPqzN7woy85ijapJOhNvg" target='_blank'>
                                ...
                                <Link href="https://blog.naver.com/oklasik3" target='_blank'>
                                ...
                                <Link href="https://www.facebook.com/oklasik" target='_blank'>
                                ...
                                <Link href="https://www.instagram.com/oklasik1004/" target='_blank'>
                                ...
                                <Link href="https://www.naver.com/oklasik" target='_blank'>
                                ...
                                <Link href="https://oklasik1004.tistory.com/" target='_blank'>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                        <g>
                            ...
                            <div className={styles.info_corp}>
                                <div className={styles.box}>
                                    <div className={styles.ico}>
                                        <Image src="/assets/icons/ft_corp_01.png" alt="문화체육관광부-한국관광공사" width={42} height={42} />
                                    </div>
                                    <p>문화체육관광부-한국관광공사 <br /> 의료관광 공식승인</p>
                                </div>
                                <div className={styles.box}>
                                    <div className={styles.ico}>
                                        <Image src="/assets/icons/ft_corp_02.svg" alt="서울특별시 의료관광 협력기관" width={42} height={42} />
                                    </div>
                                    <p>서울특별시 <br /> 의료관광 협력기관 선정</p>
                                </div>
                                <div className={styles.box}>
                                    <div className={styles.ico}>
                                        <Image src="/assets/icons/ft_corp_03.svg" alt="보건복지부 그린처방의원" width={42} height={42} />
                                    </div>
            ...
            <div className={`${styles.quick_menu} ${isVisible ? styles.show : ''}`}>
                <div className={styles.quick}>
                    <Link href="https://www.oklasik.com/?p=41_write">
                        <div className={styles.ico}><Image src="/assets/icons/ico_online.png" alt="밝은성모안과의원" fill sizes='100%' /></div>
                        <span>온라인상담</span>
                    </Link>
                    <Link href="https://www.oklasik.com/promotion/home_live_main.html" target="_blank">
                        <div className={styles.ico}><Image src="/assets/icons/ico_chat.png" alt="밝은성모안과의원" fill sizes='100%' /></div>
                        <span>채팅상담</span>
                    </Link>
                    <Link href="https://m.booking.naver.com/booking/13/bizes/573847?theme=place&area=ple">
                        <div className={styles.ico}>
                    ...
                    <Link href="https://www.oklasik.com/?p=39">
                        <div className={styles.ico}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <Link href="https://www.oklasik.com/?p=11#mapView">
