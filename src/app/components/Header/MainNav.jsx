...
export default function MainNav({ headerNavRef, handleNavMouseEnter, handleNavMouseLeave }) {
    return (
        <nav className={`${styles.navigation}`}
            onMouseEnter={handleNavMouseEnter}
            onMouseLeave={handleNavMouseLeave}>
            <ul className={styles.depth1} ref={headerNavRef}>
              <li>
                <Link href="/">밝은성모안과</Link>
