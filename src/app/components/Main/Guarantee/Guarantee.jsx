        ...
        <section className={styles["sc-guarantee"]}>
            <div className={`${styles.inner} ${styles.type02}`}>
                <div className={styles.left}>
                    ...
                    <img src="/assets/main/img-gaurantee01.webp" alt="평생보장" data-aos="fade-up" data-aos-easing="ease" className={styles.img} />
                ...
                <div className={styles.right}>
                    <div className={styles["img-area"]}>
                        <img src="/assets/main/img-gaurantee02.webp" alt="밝은성모안과 수술보증서" data-aos="fade-up" data-aos-delay="300" data-aos-easing="ease" className={styles.img} />
                    </div>
                </div>
            </div>
        </section>
